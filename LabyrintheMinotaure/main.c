...
void jeuONE(int score, int choixLabyrinthe, int labyrintheChoisi[HauteurLabyrinthe][LargeurLabyrinthe], int posH[2], int posM[2], int labyrintheManifeste[HauteurLabyrinthe+1][LargeurLabyrinthe],int clauseDeSortie, char touche); //Procédure qui permet le premier jeu avec le deplacement unique du héro
void jeuTWO(int score, int choixLabyrinthe, int labyrintheChoisi[HauteurLabyrinthe][LargeurLabyrinthe], int posH[2], int posM[2], int labyrintheManifeste[HauteurLabyrinthe+1][LargeurLabyrinthe], int clauseDeSortie, char touche); //Procédure qui permet le second jeu avec le deplacement du héro et du minotaure
...
int main()
{
    ...
    char touche; //utilisé pour traduire la touche enfoncée
...
void miseEnPlacePerso(int posH[2], int posM[2], int Labyrinthe[HauteurLabyrinthe][LargeurLabyrinthe]) //met en place les personnes dans le tableau avec les chiffres 2, 3 et 4
{
    ...
    do
    {
        ...
        if(Labyrinthe[posX][posY]==0)
        {
            ...
            test = 2;//mets la valeur à 2 pour sortir de la boucele
        };
    }while(test == 1);
     do
    {
